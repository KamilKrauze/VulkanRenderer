...
std::vector<Vertex> vertices {
    {{-0.5f, -0.5f,  -0.5f}, {1.0f, 0.0f, 0.0f}, {-1.0f, -1.0f,  -1.0f}, {1.0f, 0.0f}}, // Vertex 0
    {{ 0.5f, -0.5f,  -0.5f}, {0.0f, 1.0f, 0.0f}, { 1.0f, -1.0f,  -1.0f}, {0.0f, 0.0f}}, // Vertex 1
    {{ 0.5f,  0.5f,  -0.5f}, {0.0f, 0.0f, 1.0f}, { 1.0f,  1.0f,  -1.0f}, {0.0f, 1.0f}}, // Vertex 2
    {{-0.5f,  0.5f,  -0.5f}, {1.0f, 1.0f, 1.0f}, {-1.0f,  1.0f,  -1.0f}, {1.0f, 1.0f}}, // Vertex 3
};
