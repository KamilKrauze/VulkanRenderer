...
void Application::createImg(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat fmt, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags props, VkImage& img, VkDeviceMemory& imgMemory)
{
